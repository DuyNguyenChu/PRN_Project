...
function VehicleStatusFormPopup({ item, onClose, apiUrl, token, onSuccess, showConfirmModal, showNotifyModal }) {
    const initialState = {
        name: item?.name || '',
        ...
        LastModifiedDate: item?.LastModifiedDate || new Date().toISOString().split('T')[0],
    };
        ...
        <div className="popup-overlay">
            <div className="popup-content p-4 rounded shadow bg-white">
                ...
                <div className="form-group mt-3">
                    ...
                    <input type="text" className="form-control" value={values.LastModifiedDate} disabled />
                </div>
...
export default VehicleStatusFormPopup;
