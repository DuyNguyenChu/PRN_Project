...
function ActionFormPopup({ item, onClose, apiUrl, token, onSuccess, showConfirmModal, showNotifyModal }) {
    const initialState = {
        name: item?.name || '',
    ...
    const validationRules = {
        ...
        description: [maxLength(500)], // Mô tả: Tối đa 500 ký tự
    };
    ...
    return (
        <div className="popup-overlay">
            <div className="popup-content p-4 rounded shadow bg-white">
                <h5>{item ? 'Cập nhật hành động' : 'Thêm mới hành động'}</h5>
...
export default ActionFormPopup;
