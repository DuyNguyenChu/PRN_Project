...
export default function ViolationTypeTable({ apiUrl, token, onEdit, refreshFlag, filters }) {
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <p>Bạn có chắc muốn xóa loại vi phạm này không?</p>
                            </div>
