            ...
            <table className="table table-hover">
                <thead>
                    <tr className="text-uppercase text-gray-500 fs-7">
                        ...
                        <th onClick={() => handleSort('ManufactureYear')} style={{ cursor: 'pointer' }}>
                            Năm sản xuất {sortField === 'ManufactureYear' && (sortDir === 'asc' ? '▲' : '▼')}
                        </th>
                    ...
                    {loading ? (
                        ...
                        data.map((row, index) => (
                            <tr key={row.id}>
                                ...
                                <td>{moment(row.ManufactureYear).format('DD/MM/YYYY HH:mm:ss')}</td>
