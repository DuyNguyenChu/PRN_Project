...
import VehicleInspectionTable from '../Table/VehicleInspectionTable';
import '../styles/css/UserStatus.css';
import VehicleInspectionPopup from '../Table/VehicleInspectionPopup';
...
export default function VehicleInspection({ permissionFlags }) {
    const [showFilter, setShowFilter] = useState(false);
    const toggleFilter = () => setShowFilter(!showFilter);

    const apiUrl = `${API_URL}/vehicle-inspections`; // URL API của bạn
            ...
            <div className="col-sm-12 col-xl-12 py-4">
                <div className="bg-light rounded h-100 p-4">
                    <div className="d-flex justify-content-between align-items-center mb-4">
                        <h6 className="mb-4">Danh sách xe</h6>
