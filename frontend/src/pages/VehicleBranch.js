...
import VehicleBranchTable from '../Table/VehicleBranchTable';
import '../styles/css/UserStatus.css';
import VehicleBranchFormPopup from '../Table/VehicleBranchFormPopup';
...
export default function VehicleBranch({ permissionFlags }) {
    const [showFilter, setShowFilter] = useState(false);
    const toggleFilter = () => setShowFilter(!showFilter);

    const apiUrl = `${API_URL}/VehicleBranch`; // URL API của bạn
            ...
            <div className="col-sm-12 col-xl-12 py-4">
                <div className="bg-light rounded h-100 p-4">
                    <div className="d-flex justify-content-between align-items-center mb-4">
                        <h6 className="mb-4">Danh sách Chi nhánh xe</h6>
