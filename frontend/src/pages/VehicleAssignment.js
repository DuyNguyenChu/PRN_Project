...
import VehicleAssignmentTable from '../Table/VehicleAssignmentTable';
import '../styles/css/UserStatus.css';
import VehicleAssignmentPopup from '../Table/VehicleAssignmentPopup';
...
export default function VehicleAssignment({ permissionFlags }) {
    const [showFilter, setShowFilter] = useState(false);
    const toggleFilter = () => setShowFilter(!showFilter);

    const apiUrl = `${API_URL}/vehicle-assignments`; // URL API của bạn
