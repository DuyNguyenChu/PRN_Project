...
import TripRequestStatusTable from '../Table/TripRequestStatusTable';
import '../styles/css/TripRequestStatus.css';
import TripRequestStatusFormPopup from '../Table/TripRequestStatusFormPopup';
...
export default function TripRequestStatus() {
    const [showFilter, setShowFilter] = useState(false);
    const toggleFilter = () => setShowFilter(!showFilter);

    const apiUrl = `${API_URL}/TripRequestStatus`; // URL API của bạn
    ...
    const navigate = useNavigate(); // THÊM VÀO
        ...
        useEffect(() => {
            if (!canView(PERMISSION_IDS.TRIP_REQUEST_STATUS)) {
                console.warn(`Người dùng không có quyền xem trang Action (ID: ${PERMISSION_IDS.TRIP_REQUEST_STATUS}). Đang chuyển hướng...`);
            ...
            <div className="col-sm-12 col-xl-12 py-4">
                <div className="bg-light rounded h-100 p-4">
                    <div className="d-flex justify-content-between align-items-center mb-4">
                        <h6 className="mb-4">Trạng thái yêu cầu</h6>
