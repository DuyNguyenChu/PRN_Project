...
import VehicleTypePopup from '../Table/VehicleTypePopup';
...
export default function VehicleType({ permissionFlags }) {
    const [showFilter, setShowFilter] = useState(false);
    const toggleFilter = () => setShowFilter(!showFilter);

    const apiUrl = `${API_URL}/vehicle-types`; // URL API của bạn
