...
import VehicleStatusTable from '../Table/VehicleStatusTable';
import '../styles/css/UserStatus.css';
import VehicleStatusFormPopup from '../Table/VehicleStatusFormPopup';
...
export default function VehicleStatus({ permissionFlags }) {
    const [showFilter, setShowFilter] = useState(false);
    const toggleFilter = () => setShowFilter(!showFilter);

    const apiUrl = `${API_URL}/VehicleStatus`; // URL API của bạn
            ...
            <div className="col-sm-12 col-xl-12 py-4">
                <div className="bg-light rounded h-100 p-4">
                    <div className="d-flex justify-content-between align-items-center mb-4">
                        <h6 className="mb-4">Danh sách trạng thái xe</h6>
