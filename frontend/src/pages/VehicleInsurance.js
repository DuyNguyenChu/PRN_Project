...
import VehicleInsuranceTable from '../Table/VehicleInsuranceTable';
import '../styles/css/UserStatus.css';
import VehicleInsurancePopup from '../Table/VehicleInsurancePopup';
...
export default function VehicleInspection({ permissionFlags }) {
    ...
    const apiUrl = `${API_URL}/vehicle-insurances`; // URL API của bạn
