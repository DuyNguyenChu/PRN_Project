...
import VehicleAccidentTable from '../Table/VehicleAccidentTable';
import '../styles/css/UserStatus.css';
import VehicleAccidentPopup from '../Table/VehicleAccidentPopup';
...
export default function VehicleAccident({ permissionFlags }) {
    const [showFilter, setShowFilter] = useState(false);
    const toggleFilter = () => setShowFilter(!showFilter);

    const apiUrl = `${API_URL}/vehicle-accident`; // URL API của bạn
