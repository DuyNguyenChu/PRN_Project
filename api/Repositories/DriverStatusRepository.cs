...
{
    public class DriverStatusRepository : RepositoryBase<DriverStatus, int>, IDriverStatusRepository
    {
        private readonly PrnprojectContext _context;
        public DriverStatusRepository(PrnprojectContext context, IUnitOfWork unitOfWork) : base(context, unitOfWork)
        {
            _context = context;
        }

        public async Task<DTResult<DriverStatusAggregate>> GetPagedAsync(api.Extensions.DTParameters parameters)
        {
            ...
            var query = _context.DriverStatuses
                .Where(x => !x.IsDeleted)
                .Select(x => new DriverStatusAggregate
                {
                    Color = x.Color,
            ...
            var data = new DTResult<DriverStatusAggregate>
            {
