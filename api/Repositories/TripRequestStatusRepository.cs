...
{
    public class TripRequestStatusRepository : RepositoryBase<TripRequestStatus, int>, ITripRequestStatusRepository
    {
        private readonly PrnprojectContext _context;
        public TripRequestStatusRepository(PrnprojectContext context, IUnitOfWork unitOfWork) : base(context, unitOfWork)
        {
            _context = context;
        }
        public async Task<DTResult<TripRequestStatusAggregate>> GetPagedAsync(api.Extensions.DTParameters parameters)
        {
            ...
            var query = _context.TripRequestStatuses
                .Where(x => !x.IsDeleted)
                .Select(x => new TripRequestStatusAggregate
                {
                    Color = x.Color,
            ...
            var data = new DTResult<TripRequestStatusAggregate>
            {
