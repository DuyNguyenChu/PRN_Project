...
{
    public class ViolationTypeRepository : RepositoryBase<ViolationType, int>, IViolationTypeRepository
    {
        private readonly PrnprojectContext _context;
        public ViolationTypeRepository(PrnprojectContext context, IUnitOfWork unitOfWork) : base(context, unitOfWork)
        {
            _context = context;
        }
        public async Task<DTResult<ViolationTypeAggregate>> GetPagedAsync(api.Extensions.DTParameters parameters)
        {
            ...
            var query = _context.ViolationTypes
                .Where(x => !x.IsDeleted)
                .Select(x => new ViolationTypeAggregate
                {
            ...
            var data = new DTResult<ViolationTypeAggregate>
            {
