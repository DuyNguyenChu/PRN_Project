...
{
    public class ExpenseTypeRepository : RepositoryBase<ExpenseType, int>, IExpenseTypeRepository
    {
        private readonly PrnprojectContext _context;
        public ExpenseTypeRepository(PrnprojectContext context, IUnitOfWork unitOfWork) : base(context, unitOfWork)
        {
            _context = context;
        }

        public async Task<DTResult<ExpenseTypeAggregate>> GetPagedAsync(api.Extensions.DTParameters parameters)
        {
            ...
            var query = _context.ExpenseTypes
                .Where(x => !x.IsDeleted)
                .Select(x => new ExpenseTypeAggregate
                {
            ...
            var data = new DTResult<ExpenseTypeAggregate>
            {
