...
{
    public class UserStatusRepository : RepositoryBase<UserStatus, int>, IUserStatusRepository
    {
        private readonly PrnprojectContext _context;

        public UserStatusRepository(PrnprojectContext context, IUnitOfWork unitOfWork) : base(context, unitOfWork)
        {
            _context = context;
        }

        public async Task<DTResult<UserStatusAggregate>> GetPagedAsync(api.Extensions.DTParameters parameters)
        {
            ...
            var data = new DTResult<UserStatusAggregate>
            {
